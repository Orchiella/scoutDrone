...
import config as DB
from HelmetNight import mathUtil
from HelmetNight.const import PENETRABLE_BLOCK_TYPE
from HelmetNight.dataManager import DataManager
...
class ServerSystem(serverApi.GetServerSystemCls()):
    ...
    def IsWearing(self, playerId):
        ...
        item = comp.GetPlayerItem(serverApi.GetMinecraftEnum().ItemPosType.ARMOR, 0)
