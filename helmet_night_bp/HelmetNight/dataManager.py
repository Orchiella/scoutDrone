...
class DataManager(object):
    default_player_settings = [
        ...
        ("func_sensing_key", {"description": "§6[感应]§fPC版使用键 0即无 1-26即A-Z键", "type":"int", "range": (0, 26), "default": 0}),
        ("func_sensing_cd", {"description": "§6[感应]§f冷却秒数", "type": "int", "range": (1, 60), "default": 6}),
        ("func_sensing_durability_consumption", {"description": "§6[感应]§f消耗耐久", "type": "int", "range": (0, 100), "default": 10}),
        ...
        ("func_invisibility_key",{"description": "§b[匿迹]§fPC版使用键 0即无 1-26即A-Z键", "type": "int", "range": (0, 26), "default": 0}),
        ("func_invisibility_cd", {"description": "§b[匿迹]§f冷却秒数", "type": "int", "range": (1, 60), "default": 6}),
        ("func_invisibility_durability_consumption",{"description": "§b[匿迹]§f消耗耐久", "type": "int", "range": (0, 100), "default": 10}),
        ...
        ("func_night_vision_key",{"description": "§5[夜视]§fPC版使用键 0即无 1-26即A-Z键", "type": "int", "range": (0, 26), "default": 0}),
        ("func_night_vision_cd", {"description": "§5[夜视]§f冷却秒数", "type": "int", "range": (1, 60), "default": 6}),
        ...
        ("func_light_key",{"description": "§e[探照]§fPC版使用键 0即无 1-26即A-Z键", "type": "int", "range": (0, 26), "default": 0}),
        ("func_light_cd", {"description": "§e[探照]§f冷却秒数", "type": "int", "range": (1, 60), "default": 6}),
        ("func_light_durability_consumption",{"description": "§e[探照]§f消耗耐久", "type": "int", "range": (0, 100), "default": 10}),
