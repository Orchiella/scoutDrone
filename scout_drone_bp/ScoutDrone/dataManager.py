...
DEFAULT_PLAYER_SETTINGS = [
    ...
    ("battery_consume_percentage",
     {"description": "§f飞行耗电速度放缩百分比", "type": "int", "range": (1, 1000), "default": 100}),
    ("drone_health", {"description": "§f无人机血量", "type": "int", "range": (1, 1000), "default": 100}),
    ("speed_up_amplifier", {"description": "§f加速倍率", "type": "int", "range": (2, 10), "default": 3}),
    ("speed_up_cost", {"description": "§f加速消耗电量", "type": "int", "range": (0, 1000), "default": 3}),
    ...
    ("load1_cost", {"description": "§f引力钩爪消耗电量", "type": "int", "range": (0, 1000), "default": 4}),
    ...
    ("explode_cost", {"description": "§f自爆消耗耐久", "type": "int", "range": (0, 1000), "default": 30}),
    ("explode_damage_percentage",
     {"description": "§f自爆伤害缩放百分比", "type": "int", "range": (0, 1000), "default": 100}),
...
DEFAULT_PLAYER_DATA = {
    "func_shoot_pos": (-60, 30), "func_shoot_size": 50, "func_shoot_visible": True,
    "func_sight_pos": (-38, 30), "func_sight_size": 50, "func_sight_visible": True,
    "func_inspect_pos": (52, -60), "func_inspect_size": 40, "func_inspect_visible": True,
    "func_deploy_pos": (145, -60), "func_deploy_size": 40, "func_deploy_visible": True,
    "func_settings_pos": (62, -94), "func_settings_size": 20, "func_settings_visible": True,
    "func_recover_pos": (-65, -40), "func_recover_size": 40, "func_recover_visible": True,
    "func_control_pos": (-110, -40), "func_control_size": 40, "func_control_visible": True,
    "func_function_pos": (-20, -40), "func_function_size": 40, "func_function_visible": True,
    "func_scan_pos": (-110, -95), "func_scan_size": 40, "func_scan_visible": True,
    "func_mark_pos": (-65, -95), "func_mark_size": 40, "func_mark_visible": True,
