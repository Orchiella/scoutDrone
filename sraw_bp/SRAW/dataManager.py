...
class DataManager(object):
    default_player_settings = [
        ...
        ("velocity", {"description": "§f飞行速度", "type": "int", "range": (1, 10), "default": 1}),
        ("max_time", {"description": "§f最大飞行秒数", "type": "int", "range": (1, 120), "default": 20}),
        ...
        ("func_rev_key", {"description": "§f移动光源强度 §7(0代表无)", "type": "int", "range": (0, 16), "default": 0}),
        ("func_rev_size", {"description": "§f移动光源强度 §7(0代表无)", "type": "int", "range": (0, 16), "default": 7}),
        ("func_rev_enabled", {"description": "§f移动光源强度 §7(0代表无)", "type": "bool", "default": True}),
    ]
