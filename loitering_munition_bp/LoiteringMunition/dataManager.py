...
class DataManager(object):
    default_player_settings = [
        ...
        ("velocity", {"description": "§f飞行速度", "type": "int", "range": (1, 20), "default": 3}),
        ...
        ("durability_consumption", {"description": "§f消耗耐久 §7(可改为0)", "type": "int", "range": (0, 50), "default": 1}),
        ("aim_sign_size_percentage", {"description": "§f落点标志放缩", "type": "int", "range": (30, 200), "default": 100}),
        ("alerting_sign_size_percentage", {"description": "§f巡飞弹标志放缩", "type": "int", "range": (30, 200), "default": 100}),
        ...
        ("explode_damage_percentage", {"description": "§f爆炸伤害缩放 §7(单位：百分比)", "type": "int", "range": (1, 1000), "default": 300}),
        ("func_aim_enabled", {"description": "§b[瞄准按钮]§f显示", "type": "bool", "default": True}),
        ("func_aim_green_intense", {"description": "§b[瞄准按钮]§f滤镜强度 §7(单位：百分比)", "type": "int", "range": (0, 100), "default": 30}),
        ...
        ("func_inspect_key", {"description": "§e[检视按钮]§fPC键位 1-26即A-Z", "type": "int", "range": (0, 26), "default": 25}),
        ("func_inspect_size", {"description": "§e[检视按钮]§f大小放缩 §7(单位：百分比)", "type": "int", "range": (30, 200), "default": 100,"private":True}),
    ]

    default_player_data = {"func_aim_pos": (165, 33),"func_fire_pos": (215, 33), "func_explode_pos": (275, 33), "func_inspect_pos": (335, 33),
