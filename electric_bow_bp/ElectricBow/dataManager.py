...
class DataManager(object):
    default_player_settings = [
        ...
        ("func_sensing_enabled", {"description": "§e[电场感应]§f显示按钮", "type": "bool", "default": True}),
        ("func_sensing_size", {"description": "§e[电场感应]§f按钮大小缩放 §7(单位:百分比)", "type": "int", "range": (30,200), "default": 100}),
        ("func_sensing_key", {"description": "§e[电场感应]§fPC版绑定键 0即无 1-26即A-Z键", "type":"int", "range": (0, 26), "default": 0}),
        ("func_sensing_cd", {"description": "§e[电场感应]§f冷却秒数", "type": "int", "range": (1, 60), "default": 6}),
        ("func_sensing_radius", {"description": "§e[电场感应]§f作用半径", "type": "int", "range": (1, 100), "default": 15}),
        ("func_sensing_duration", {"description": "§e[电场感应]§f标记秒数", "type": "int", "range": (1, 60), "default": 3}),
        ("func_sensing_max", {"description": "§e[电场感应]§f最大标记数量", "type": "int", "range": (1, 100), "default": 50}),
        ...
        ("func_release_damage_percentage",{"description": "§b[电能爆发]§f总伤害缩放 §7(单位:百分比)", "type": "int", "range": (30, 300), "default": 150}),
    ]
