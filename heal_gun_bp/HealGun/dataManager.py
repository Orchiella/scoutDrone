...
class DataManager(object):
    default_player_settings = [
        ...
        ("func_self_heal_cd", {"description": "§d[技能:自我治疗]§f冷却秒数", "type": "int", "range": (1, 60), "default": 10}),
        ("func_self_heal_duration", {"description": "§d[技能:自我治疗]§f效果秒数", "type": "int", "range": (1, 60), "default": 4}),
        ("func_self_heal_amplifier", {"description": "§d[技能:自我治疗]§f效果强度", "type": "int", "range": (1, 5), "default": 2}),
        ...
        ("func_launch_bomb_amplifier", {"description": "§b[技能:投放增益]§f效果强度", "type": "int", "range": (1, 5), "default": 2}),
    ]
