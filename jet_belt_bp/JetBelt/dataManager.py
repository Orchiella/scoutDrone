...
class DataManager(object):
    default_player_settings = [
        ...
        ("func_use_durability_consumption", {"description": "§9[喷气]§f消耗耐久", "type": "int", "range": (0, 60), "default": 1}),
        ...
        ("func_boost_use_durability_consumption", {"description": "§9[喷气]§f提高功率时额外消耗的耐久", "type": "int", "range": (0, 60), "default": 1}),
        ("func_use_kill_to_resume", {"description": "§9[喷气]§f击杀生物后立即充能一次", "type": "bool", "default": True}),
        ("func_use_size", {"description": "§9[喷气]§f按钮大小缩放 §7(单位:百分比)", "type": "int", "range": (30,200), "default": 125}),
        ("func_flash_enabled", {"description": "§5[技能:闪现]§f显示按钮", "type": "bool", "default": True}),
        ("func_flash_cd", {"description": "§5[技能:闪现]§f冷却秒数", "type": "int", "range": (1, 60), "default": 6}),
        ...
        ("func_brake_enabled", {"description": "§b[技能:制动]§f显示按钮", "type": "bool", "default": True}),
        ("func_brake_cd", {"description": "§b[技能:制动]§f冷却秒数", "type": "int", "range": (1, 60), "default": 3}),
        ("func_brake_durability_consumption", {"description": "§b[技能:制动]§f消耗耐久", "type": "int", "range": (0, 100), "default": 10}),
        ("func_fear_enabled", {"description": "§e[技能:震慑]§f显示按钮", "type": "bool", "default": True}),
        ("func_fear_cd", {"description": "§e[技能:震慑]§f冷却秒数", "type": "int", "range": (1, 60), "default": 5}),
        ...
        ("func_switch_power_enabled", {"description": "§d[功能:切换功率]§f显示按钮", "type": "bool", "default": True}),
    ]
